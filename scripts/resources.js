...
function summarize_room_internal(room) {
    ...
    reduced_resources[RESOURCE_ENERGY] = reduced_resources[RESOURCE_ENERGY] || 0;
    ...
    let creep_confusion_counts = _.clone(DEFAULT_ROLE_COUNTS);
    let creep_idle_counts = _.clone(DEFAULT_ROLE_COUNTS);
